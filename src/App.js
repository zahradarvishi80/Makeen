...
import Maintors from "./Component/Maintors";
...
export default function App() {
  return (
    <div className="flex max-w-md  mb-10 mx-auto flex-col container sm:max-w-xl  md:max-w-3xl lg:max-w-4xl xl:max-w-5xl 2xl:max-w-20xl">
      <SimpleSlider />
      <Status />
      <VideoPlayer />
      <AttibutesBox />
      ...
      <div className="flex w-[100%] h-[280px] mt-20">
        ...
        <div className="flex w-[50%] h-[280px] flex-col">
          <p style={{ fontFamily: "ExtraBold", marginTop: 50 }}>
            متودولوژی خاص آموزشی
          </p>
          <div className="flex w-[90%] h-[280px]">
            <p style={{ fontFamily: "Bold", marginTop: 20 }}>
